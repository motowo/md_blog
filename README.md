...
詳細な構造と開発手順は [開発者ガイド](docs/03_developer-guide.md) をご確認ください。

## 📚 ドキュメント

### 📋 プロジェクト仕様
- [📋 要件定義書](docs/01_requirements.md) - システム要件と機能仕様
- [🏗️ 技術設計書](docs/02_design.md) - API・データベース設計
- [📊 実装状況](docs/05_implementation.md) - 詳細な開発進捗
- [📝 開発タスク](docs/04_tasks.md) - 開発計画とタスク管理

### 🔧 開発者向け
- [👩‍💻 開発者ガイド](docs/03_developer-guide.md) - 開発環境・フロー完全ガイド
- [🔌 API リファレンス](docs/06_api-reference.md) - REST API仕様書
- [🗄️ データベース管理ガイド](docs/xx_database-persistence.md) - マイグレーション・Seeder完全ガイド

### 🧪 テスト・品質
- [🧪 テストデータ仕様](docs/07_test.md) - テストアカウント・データの詳細仕様
- [⚡ パフォーマンステストガイド](docs/08_performance-test.md) - 大規模データ生成・負荷テスト
...
詳細な開発ガイドラインは [開発者ガイド](docs/03_developer-guide.md) を参照してください。
...
- **開発ガイド**: [docs/03_developer-guide.md](docs/03_developer-guide.md)
- **トラブルシューティング**: [docs/xx_database-persistence.md](docs/xx_database-persistence.md)
- **API仕様**: [docs/06_api-reference.md](docs/06_api-reference.md)